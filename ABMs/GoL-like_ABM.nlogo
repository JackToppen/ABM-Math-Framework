...
"" ""
PENS
"total" 1.0 0 -16777216 true "" "plot count cells with [ color = white ]"
...
@#$#@#$#@
<experiments>
  <experiment name="population-sweep" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    ...
    <enumeratedValueSet variable="record-type">
      <value value="&quot;None&quot;"/>
    </enumeratedValueSet>
  ...
  <experiment name="pop-0450" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>count turtles</metric>
  ...
  <experiment name="pop-0800" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>count turtles</metric>
  ...
  <experiment name="pop-1250" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>count turtles</metric>
